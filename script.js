...
// Símbolo SVG de polígono/parcela para los botones
const svgPolygon = `
      ...
      if (geojsonData.features && geojsonData.features.length > 0) {
        ...
        const capaLayer = L.geoJSON(geojsonData, {
          ...
          onEachFeature: function (feature, layer) {
            ...
            // Construcción del Popup con los textos actualizados
        ...
        // Crear botón interactivo usando el SVG de polígono
        const btn = document.createElement('button');
        btn.className = 'layer-btn';
        const nombreMostrar = geojsonData.features[0].properties.name || tabla; 
        
        // Inserción del icono SVG y el texto
